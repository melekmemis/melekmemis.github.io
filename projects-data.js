window.projectData = [
  ...
  },
  {
    ...
    "process": [
      { "text": "Sistemi tek bir merkezi kart yerine görev bazında ayrılmış 4 kart olarak tasarladım: sensör verisi toplayan Sensör kartı, LoRa üzerinden yer istasyonuyla haberleşen Haberleşme kartı, tüm veriyi toplayıp kaydeden merkezi işlem (OBC) kartı ve yer istasyonu kartı. Kartlar arası iletişimi CAN bus üzerinden kurdum, böylece kartlardan biri yeniden tasarlansa bile haberleşme protokolü değişmeden kalabiliyor." },
      { "text": "Sensör kartında roket projesinden uyarladığım IMU + barometre + GPS okuma ve Kalman filtresi kodlarını kullandım; NMEA ayrıştırma ve DMA tabanlı okuma ile CPU yükünü düşük tuttum." },
      { "text": "Merkezi işlem kartında gelen sensör verisini CAN üzerinden topluyor, INA219 ile güç tüketimini ölçüyor, tüm veriyi SD karta ve yedek olarak harici flash belleğe (W25Q32) kaydediyorum." },
      { "text": "Haberleşme kartı, toplanan veriyi LoRa üzerinden yer istasyonuna iletiyor; yer istasyonu kartı da gelen paketleri çözüp seri port üzerinden bilgisayara aktarıyor." },
    ]
  },
];