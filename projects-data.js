window.projectData = [
  {
    ...
    "process": [
      { "text": "Gereksinim analizi ve komponent seçimi (STM32F4, MPU6000 vb.)", "image": "resim.png" },
      { "text": "Şematik tasarım ve güç katmanı optimizasyonu" },
      { "text": "4 katmanlı PCB layout tasarımı ve sinyal bütünlüğü kontrolü", "image": "resim2.png" },
      { "text": "Prototip üretimi ve temel çevre birimi testleri (Örnek Video)", "video": "https://www.youtube.com/watch?v=ScMzIvxBSi4" }
    ],
    "images": ["resim2.png"]
  },
  {
